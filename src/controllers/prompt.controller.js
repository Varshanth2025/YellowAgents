...
/**
 * @desc    Get prompt for a project
 * @route   GET /api/projects/:projectId/prompt
 * @access  Private
 */
exports.getPrompt = async (req, res, next) => {
  try {
    ...
    // Get active prompt for this project
...
/**
 * @desc    Create or update prompt for a project
 * @route   POST /api/projects/:projectId/prompt
 * @access  Private
 */
